 ...
 */
static inline void cross_product (Real* vec1, Real* vec2, Real* out)
{
  for (int n = 0; n < 3; n++)
 ...
 */
static inline void velocity_3to4 (Real* v, Real* u, Real* gamma)
{
 ...
 */
static inline void velocity_4to3 (Real* u, Real* v, Real* gamma)
{
